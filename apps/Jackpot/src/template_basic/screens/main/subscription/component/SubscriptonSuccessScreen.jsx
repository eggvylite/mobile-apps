...
export default function SubscriptonSuccessScreen() {
    const navigation = useNavigation();
    const route = useRoute();
    const { amount, last4, brand, message } = route.params || {};
            ...
            <Animated.View style={[styles.container, { opacity: fadeAnim }]}>
                ...
                >
                    ...
                    <Animated.View style={[styles.successContainer, { transform: [{ scale: scaleAnim }] }]}>
                        <Image
                            source={require('../../../../../../assets/images/subsuccess.png')}
                    ...
                    <Animated.View style={{ transform: [{ translateY: bounceAnim }] }}>
                        ...
                        <Text style={styles.successSubtitle}>
                            {message || 'Your subscription is now active. You’re all set to access your eligible benefits and services under your selected plan.!'}
                        </Text>
                    </Animated.View>
