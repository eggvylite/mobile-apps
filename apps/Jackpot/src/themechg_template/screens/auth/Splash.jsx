  ...
  const getDetails = async () => {
    ...
    setTimeout(async () => {
      ...
      if (loginfo && loginfo.phone) {
        ...
        // api.post('customerlogin/getotp', payload).then((response) => {
  ...
  return (
    <View style={styles.whiteContainer}>
      ...
      <View style={{ flex: 1.8, alignItems: 'center', justifyContent: 'center' }}>
        ...
        {
          themedata?.Success !== 'No' && themedata.logo ?
            <CloudImage
              style={{ width: 200, height: 110 }}
              page='login'
              cloudSource={themedata.logo} /> :
            <Image source={require('../../../../assets/images/splash.png')} style={[splashstyles.image, { width: 200, height: 100 }]} resizeMode='contain' />
        }
