    ...
    useEffect(() => {
        if (0 < statements.length && currentMonth) {
            ...
            const ch = statements.filter(item => {
                ...
                const matchword = atmkeyword.length > 0 && new RegExp(`\\b(${atmkeyword.join("|")})\\b`, "i").test(item.description)
            ...
            if (dateRange) {
                if (timeLine === '3' || timeLine === '4') {
                    bardata = splitMonthlyChart(ch, getmonth / 1, getyear / 1, leftbarcolr, rightbarcolor)
                                        ...
                                        <View style={{ flex: 1 }}>
                                            {
                                                0 < record.length ? <>
                                                    ...
                                                    <View style={[{ marginStart: 10, marginEnd: 10, marginTop: 10, padding: 10 }]}>
                                                        <View>
                                                            <Text style={styles.listTitle}>List of ATM</Text>
